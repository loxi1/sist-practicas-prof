            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{route('perfil.index')}}" class="btn btn-sm btn-default float-right"><i class="fas fa-reply-all"> Atrás</i>
                  </a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  {!! Form::model($persona,['route'=>['perfil.update',$persona],'method'=>'put']) !!}
                    <div class="form-row">                    
